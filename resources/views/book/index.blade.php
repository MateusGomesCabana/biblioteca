                            ...
                            @foreach($books as $book)
                                <tr>
                                    ...
                                    <td width="155" class="text-center">
                                        <a href="{{route('book.edit', $book->id)}}" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i>Editar</a>
                                        <a href="{{route('book.delete', $book->id)}}" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i>Excluir</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
